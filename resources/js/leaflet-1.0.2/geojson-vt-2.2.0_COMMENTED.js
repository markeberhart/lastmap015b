...
// Main argument
/*
accepts geojson object and a tile options argument:
...
function GeoJSONVT(data, options) {
    ...
    // creates global var object called "options"
    options = this.options = extend(Object.create(this.options), options);

    // creates global "debug" boolean based on options.debug value
    var debug = options.debug;

    // if "debug" is true (1) then a new timer called "preprocess data" begins
    // a timestamp will appear designating when this code began
    // this is followed later in the script with a timestamp designating
    // when this code wraps-up with a "console.timeEnd('preprocess data')
...
function projectPoint4326(p) { //4326
